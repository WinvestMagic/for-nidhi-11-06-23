...
if box1 == 'WeLoV3YoUnidhi :)':
    ...
    original_title14 = '<b><em class = "word break"><p style="font-family:Brush Script MT, cursive; color:Black; font-size: 30px;">Go hereee: https://tinyurl.com/happy-17th-nidhi</p></em><b>'
